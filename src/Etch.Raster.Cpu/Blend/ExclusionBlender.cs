...
public static class ExclusionBlender
{
    ...
    public static void BlendScalar(ReadOnlySpan<byte> coverage, Rgba16f paint, Span<Rgba16f> row)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            float blendedR = srcR + dstR - 2.0f * srcR * dstR;
            float blendedG = srcG + dstG - 2.0f * srcG * dstG;
            float blendedB = srcB + dstB - 2.0f * srcB * dstB;
