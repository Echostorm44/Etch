...
public static class ScreenBlender
{
    ...
    public static void BlendScalar(ReadOnlySpan<byte> coverage, Rgba16f paint, Span<Rgba16f> row)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            float blendedR = 1.0f - (1.0f - srcR) * (1.0f - dstR);
            float blendedG = 1.0f - (1.0f - srcG) * (1.0f - dstG);
            float blendedB = 1.0f - (1.0f - srcB) * (1.0f - dstB);
