...
public static class HueBlender
{
    ...
    public static void BlendScalar(ReadOnlySpan<byte> coverage, Rgba16f paint, Span<Rgba16f> row)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            float br = srcR, bg = srcG, bb = srcB;
            NonSeparableBlendHelpers.SetSat(ref br, ref bg, ref bb, NonSeparableBlendHelpers.Sat(dstR, dstG, dstB));
